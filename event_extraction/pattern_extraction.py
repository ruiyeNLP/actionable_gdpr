...
with open('./TransOMCS_matched_data/node_matches.json', 'r') as f:
...
with open('./TransOMCS_matched_data/edge_matches.json', 'r') as f:
...
with open('./TransOMCS_matched_data/lemmatized_commonsense_knowledge.json', 'r') as f:
